...
def plot(START_LOGFILE, END_LOGFILE, START_PLOTFILE,  END_PLOTFILE):
...
plot(START_LOGFILE, END_LOGFILE, START_PLOTFILE,  END_PLOTFILE)
plot("./start.optimized.log", "./end.optimized.log", "./start.optimized.png",  "./end.optimized.png")
